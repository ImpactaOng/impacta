...
export default function Home() {
    return (
        <main className="gap-16 flex flex-col bg-fundoPrincipal w-full">
            <div className="flex  gap-15 bg-[url('./assets/Back.png')] bg-no-repeat bg-cover  ">
                <div className="flex flex-col justify-end w-6/12 items-center gap-10  h-96">
                    <div className=" flex flex-col justify-center">
                        <h1 className="font-regular text-corPrincipal text-8xl ">
                            IMPACTA
                        </h1>
                        <p className=" w-96 text-2sm text-white">
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Aperiam ipsa quibusdam quidem dolores impedit
                            modi consequuntur provident eaque, exercitationem,
                            perferendis rerum cupiditate? Quae facere sit
                            corrupti. Non totam nihil quos?
                        </p>
                    </div>
