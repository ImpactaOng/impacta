    ...
    return (
        <section className='bg-fundoPrincipal h-full w-full flex items-start justify-center'>
            <div className='flex flex-col w-full items-center justify-center gap-10'>
                <h2 className='text-4xl text-center text-white w-72 s580:text-5xl s580:w-96 s1080:w-4/5'>Porque <span className='text-corPrincipal'>ocorrem</span> as enchentes?</h2>
                <img className='s580:w-4/5 s1080:hidden'  src={trilhaUm} alt="" />
